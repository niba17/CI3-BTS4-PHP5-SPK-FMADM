<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <form class="user" enctype="multipart/form-data" id="inputFormTambah" action="<?= base_url('Admin/tambahData/' . 'tabel_admin/' . 'indexAkun/' . 'indexTambahDataAkun'); ?>" method="post">
        <div class="row">
        ...
        <button class="btn btn-primary disabled" type="submit" id="submit"><i class="fa-solid fa-circle-plus"></i> Tambah Data</button>
