<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      ...
      <hr class="divider">
      <a class="btn btn-primary btn-sm" href="<?= base_url('Admin/indexTambahDataAkun'); ?>">Tambah Akun <i class="fa-solid fa-circle-plus"></i></a>
    </div>
  </div>
                ...
                <tbody>
                  ...
                  foreach ($semuaData['dataAdmin'] as $key => $value) : ?>
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-primary btn-sm" href="<?= base_url('Admin/indexUbahDataAkun/' . $value->id); ?>"><i class="fa-solid fa-pen-to-square"></i></a>
